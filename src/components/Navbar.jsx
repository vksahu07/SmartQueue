            ...
            <div className="relative">
              ...
              {showNotifications && (
                <>
                  ...
                  <div className="fixed md:absolute top-16 md:top-full left-4 md:left-auto right-4 md:right-0 mt-2 w-auto md:w-80 origin-top-right rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-2 shadow-xl z-40">
